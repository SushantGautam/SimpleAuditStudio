...
class ModelEndpoint(models.Model):
    project = models.ForeignKey("core.Project", on_delete=models.CASCADE, related_name="model_endpoints")
...
class AuditProfile(models.Model):
    project = models.ForeignKey("core.Project", on_delete=models.CASCADE, related_name="audit_profiles")
