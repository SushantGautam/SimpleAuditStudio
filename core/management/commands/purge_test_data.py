...
from core.audit_events import AuditEvent, ScenarioResult
from core.audit_models import AuditRun
from core.model_registry_models import ModelEndpoint
from core.scenario_models import Scenario, ScenarioSet, ScenarioSetVersion, ScenarioSetVersionItem
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sets.delete()
        # Revisions -> scenarios
        from core.scenario_models import ScenarioRevision
