...
def _scenario_execute_impl(workflow_input: ScenarioInput, ctx: Context) -> dict:
    ...
    """
    from .audit_events import append_event, upsert_scenario_result
    from .audit_models import AuditRun
    ...
    from .engine import EngineError, run_scenario as engine_run_scenario
...
def _iter_attempted_events(run_id: str, version_item_id: str):
    from .audit_events import list_events
...
def _count_results(run_id: str) -> int:
    from .audit_events import count_results
