    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("project", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="model_endpoints", to="core.project")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("project", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="audit_profiles", to="core.project")),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=("project", "display_name"), name="unique_model_endpoint_display_name_per_project"),
        ),
        migrations.AddConstraint(
            model_name="auditprofile",
            constraint=models.UniqueConstraint(fields=("project", "name"), name="unique_audit_profile_name_per_project"),
        ),
    ]
