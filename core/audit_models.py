...
class AuditRun(models.Model):
    ...
    project = models.ForeignKey("core.Project", on_delete=models.CASCADE, related_name="audit_runs")
    name = models.CharField(max_length=250)
    status = models.CharField(max_length=30, choices=Status.choices, default=Status.QUEUED)
    scenario_set_version = models.ForeignKey("core.ScenarioSetVersion", on_delete=models.RESTRICT, related_name="audit_runs")
    target_endpoint = models.ForeignKey("core.ModelEndpoint", on_delete=models.RESTRICT, related_name="target_audit_runs")
    auditor_endpoint = models.ForeignKey("core.ModelEndpoint", on_delete=models.RESTRICT, related_name="auditor_audit_runs")
    judge_endpoint = models.ForeignKey("core.ModelEndpoint", on_delete=models.RESTRICT, related_name="judge_audit_runs")
    audit_profile = models.ForeignKey("core.AuditProfile", on_delete=models.SET_NULL, null=True, blank=True, related_name="audit_runs")
