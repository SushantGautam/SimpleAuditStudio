...
# Register domain models that live in sibling modules. These import from this
# module (Project, User), so they must be imported after those classes exist.
from . import audit_events  # noqa: E402,F401
from . import audit_models  # noqa: E402,F401
from . import model_registry_models  # noqa: E402,F401
from . import scenario_models  # noqa: E402,F401
