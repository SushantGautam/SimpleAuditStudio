...
#
# HF Spaces do not support docker-compose. This Dockerfile packs the entire
# stack (Postgres 16, Hatchet server, SimpleAudit worker, Django web) into one
# container managed by supervisord.
#
# Build:  docker build -f deploy/hf-space/Dockerfile .
# Run:    docker run -p 7860:7860 simpleaudit-hf-space
# =============================================================================
